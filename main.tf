...
module "management_groups" {
  source            = "git::https://github.com/AeternaModules/azurerm_management_group.git?ref=v5.0.0"
  management_groups = local.management_groups
}

module "management_group_policy_assignments" {
  source                              = "git::https://github.com/AeternaModules/azurerm_management_group_policy_assignment.git?ref=v5.0.0"
...
module "management_group_policy_exemptions" {
  source                             = "git::https://github.com/AeternaModules/azurerm_management_group_policy_exemption.git?ref=v5.0.0"
  management_group_policy_exemptions = local.management_group_policy_exemptions
  depends_on                         = [module.management_groups]
}

module "management_group_policy_remediations" {
  source                               = "git::https://github.com/AeternaModules/azurerm_management_group_policy_remediation.git?ref=v5.0.0"
...
module "management_group_policy_set_definitions" {
  source                                  = "git::https://github.com/AeternaModules/azurerm_management_group_policy_set_definition.git?ref=v5.0.0"
...
module "management_group_subscription_associations" {
  source                                     = "git::https://github.com/AeternaModules/azurerm_management_group_subscription_association.git?ref=v5.0.0"
...
module "management_group_template_deployments" {
  source                                = "git::https://github.com/AeternaModules/azurerm_management_group_template_deployment.git?ref=v5.0.0"
